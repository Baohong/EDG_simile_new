...
//MODIFIED TO make the anchor pointed to the place where it is clicked...
Timeline.OriginalEventPainter.prototype._onClickInstantEvent = function(icon, domEvt, evt) {
    ...
    var x = c.left + Math.ceil(icon.offsetWidth / 2);
    var y = c.top + Math.ceil(icon.offsetHeight / 2);
    
    var co = handleEvent(domEvt);
    x = co.x; y = co.y;
