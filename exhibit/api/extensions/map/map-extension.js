...
(function() {
    ...
    var scriptURLs = [];
    var cssURLs = [];
    console.log(Exhibit.MapExtension.params.service)
    if (Exhibit.MapExtension.params.service == "google") {
        ...
        scriptURLs.push("/OpenLayers/lib/OpenLayers.js");
        scriptURLs.push("https://www.openstreetmap.org/openlayers/OpenStreetMap.js");
    } else {
